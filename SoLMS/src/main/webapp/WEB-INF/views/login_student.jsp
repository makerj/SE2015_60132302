    ...
    <body class="lead">
        ...
        <div class="container">
            <div class="starter-template">
                ...
                <h1 style="display: block;"><b style="display: inline-block;">학생 페이지&nbsp;</b></h1>
                <hr>
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <a type="button" href="${pageContext.request.contextPath}/LectureController/enroll_class" class="btn btn-default" style="display: inline-block;">수강 신청</a>
                        <a type="button" href="${pageContext.request.contextPath}/LectureController/confirm_grade" class="btn btn-default button_margin" style="display: inline-block;">성적 확인</a>
